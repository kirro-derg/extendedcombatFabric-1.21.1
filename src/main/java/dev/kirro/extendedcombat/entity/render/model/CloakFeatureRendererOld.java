...
public class CloakFeatureRendererOld<T extends LivingEntity, M extends BipedEntityModel<T>, A extends BipedEntityModel<T>> extends FeatureRenderer<T, M> {
    private static final Map<String, Identifier> ARMOR_TEXTURE_CACHE = Maps.<String, Identifier>newHashMap();
    private final A outerModel;
    private final A innerModel;

    public CloakFeatureRendererOld(FeatureRendererContext<T, M> context, A innerModel, A outerModel) {
        super(context);
