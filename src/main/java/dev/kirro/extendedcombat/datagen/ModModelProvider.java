...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateItemModels(ItemModelGenerator generator) {
        ...
        generator.register(ModItems.MILK_BOTTLE, Models.GENERATED);
        generator.register(ModItems.SWEET_BERRY_MILK_BOTTLE, Models.GENERATED);
        generator.register(ModItems.CHOCOLATE_MILK_BOTTLE, Models.GENERATED);
