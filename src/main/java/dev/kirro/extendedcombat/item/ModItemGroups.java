    ...
    public static final ItemGroup EXTENDEDCOMBAT_ITEM_GROUP = Registry.register(Registries.ITEM_GROUP,
            ...
            FabricItemGroup.builder().icon(() -> new ItemStack(ModBlocks.NETHER_STEEL_BLOCK))
                    ...
                    .entries((displayContext, entries) -> {
                        ...
                        entries.add(ModItems.HUNTER_CLOAK);
                        entries.add(ModItems.HUNTER_LEGGINGS);
                        entries.add(ModItems.HUNTER_BOOTS);
                        ...
                        entries.add(ModItems.NETHER_STEEL_HUNTER_LEGGINGS);
                        entries.add(ModItems.NETHER_STEEL_HUNTER_BOOTS);
                        ...
                        entries.add(ModItems.ECHO_STEEL_HUNTER_LEGGINGS);
                        entries.add(ModItems.ECHO_STEEL_HUNTER_BOOTS);
                        ...
                        entries.add(ModItems.SWEET_BERRY_MILK_BOTTLE);
                        entries.add(ModItems.CHOCOLATE_MILK_BOTTLE);
